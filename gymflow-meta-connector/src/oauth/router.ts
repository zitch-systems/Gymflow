...
export function buildOAuthRouter(config: Config): Router {
  ...
  const asMetadata = (req: Request) => {
    ...
    return {
      ...
      service_documentation: 'https://github.com/zitch-systems/gymflow/tree/main/gymflow-meta-connector',
    };
  };
  ...
  const prMetadata = (req: Request) => {
    ...
    return {
      ...
      resource_documentation: 'https://github.com/zitch-systems/gymflow/tree/main/gymflow-meta-connector',
    };
  };
  ...
  router.post('/oauth/token', (req, res) => {
    ...
    if (!auth.ok || !auth.clientId) {
      ...
      res
        .status(401)
        .set('WWW-Authenticate', 'Basic realm="gymflow-meta-connector"')
