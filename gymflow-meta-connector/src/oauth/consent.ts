...
<title>Authorize · GymFlow Meta Connector</title>
<style>${STYLE}</style></head>
<body><div class="card">
  <h1>Authorize access</h1>
  <p class="sub">An application is asking to use the GymFlow Meta Connector.</p>
  ${error}
  <dl>
...
<meta name="viewport" content="width=device-width,initial-scale=1">
<meta name="robots" content="noindex,nofollow">
<title>${esc(title)} · GymFlow Meta Connector</title>
<style>${STYLE}</style></head>
<body><div class="card">
  <h1>${esc(title)}</h1>
